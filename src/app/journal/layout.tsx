...
const sidebarItems = [
  ...
  { label: "Checklists", href: "/journal/checklists", icon: ClipboardCheck },
  ...
  { label: "Playbooks", href: "/journal/playbooks", icon: PlaySquare },
          ...
          <header className="sticky top-0 z-20 border-b border-slate-800 bg-[#020617]/90 backdrop-blur">
            <div className="mx-auto flex h-16 w-full max-w-[1400px] items-center justify-between px-6">
              <div>
                ...
                <div className="text-xs text-slate-400">Trades, screenshots, psychology, and review notes</div>
              </div>
              <Link
                href="/"
