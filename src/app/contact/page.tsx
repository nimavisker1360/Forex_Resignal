...
export default function ContactPage() {
  ...
  return (
    <div className="relative">
      <div className="absolute inset-0 bg-[url('/images/back.jpg')] bg-cover bg-center opacity-30 z-0"></div>
      <div className="container mx-auto px-4 py-12 text-left relative z-10">
